...
dataset_path = "sample-data/train" 
...
sidebar_options = ["Image Visualization",
                   "Object Detection/Segmentation","Deep Learning Feature Extraction","Color Analysis", "Texture Analysis",
